...
import { <AWS-SECRET-KEY>ams, ChatCompletionStreamingToolRunnerParams } from "./ChatCompletionStreamingRunner.js";
...
export declare class AbstractChatCompletionRunner<EventTypes extends AbstractChatCompletionRunnerEvents, ParsedT> extends EventStream<EventTypes> {
    ...
    protected _runFunctions<FunctionsArgs extends BaseFunctionsArgs>(client: OpenAI, params: ChatCompletionFunctionRunnerParams<FunctionsArgs> | <AWS-SECRET-KEY>ams<FunctionsArgs>, options?: RunnerOptions): Promise<void>;
