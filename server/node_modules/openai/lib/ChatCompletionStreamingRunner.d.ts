...
export type <AWS-SECRET-KEY>ams<FunctionsArgs extends BaseFunctionsArgs> = Omit<ChatCompletionCreateParamsStreaming, 'functions'> & {
...
export declare class ChatCompletionStreamingRunner<ParsedT = null> extends ChatCompletionStream<ParsedT> implements AsyncIterable<ChatCompletionChunk> {
    ...
    static runFunctions<T extends (string | object)[]>(client: OpenAI, params: <AWS-SECRET-KEY>ams<T>, options?: RunnerOptions): ChatCompletionStreamingRunner<null>;
