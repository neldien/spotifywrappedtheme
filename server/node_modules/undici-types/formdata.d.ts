// Based on https://github.com/octet-stream/form-<AWS-SECRET-KEY>1995d0953a/lib/FormData.ts (MIT)
...
export declare class FormData {
  ...
  /**
   * Returns an [`iterator`](https://developer.mozilla.org/en-<AWS-SECRET-KEY>on_protocols) allowing to go through the `FormData` key/value pairs.
