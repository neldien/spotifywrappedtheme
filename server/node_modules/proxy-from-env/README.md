...
- cURL:
  ...
  https://github.<AWS-SECRET-KEY>9f7ca866ff395d1f897/lib/url.c#L4446-L4514  
  https://github.<AWS-SECRET-KEY>9f7ca866ff395d1f897/lib/url.c#L4608-L4638  

- wget: 
  https://www.gnu.org/software/wget/manual/wget.html#Proxies  
  http://git.savannah.gnu.org/cgit/wget.git/tree/src/init.c?id=<AWS-SECRET-KEY>#n383  
  http://git.savannah.gnu.org/cgit/wget.git/tree/src/retr.c?id=<AWS-SECRET-KEY>#n1278  

- W3:
  https://www.w3.org/Daemon/User/Proxies/ProxyClients.html  

- Python's urllib:
  https://github.<AWS-SECRET-KEY><AWS-SECRET-KEY>est.py#L755-L782  
  https://github.<AWS-SECRET-KEY><AWS-SECRET-KEY>est.py#L2444-L2479
